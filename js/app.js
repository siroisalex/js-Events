...
function moreContent(){
  var pBox = document.getElementById("more");
  pBox.innerHTML = bacon;
}
...
function lessContent(){
  var pLessBox = document.getElementById("less");
  pLessBox.innerHTML = "";
}
...
function zoom(){
  pBiggieBox = document.getElementById("biggie");
  pBiggieBox.style.fontSize = "150px";
}
...
var menuItems = ["french fries," + "" + " salad," + "" + " chicken nuggets"];

function valueMenu(){
  pMenuBox = document.getElementById("menu");
  pMenuBox.innerHTML = menuItems;
}
...
function redFace(){
  var pDrink = document.getElementById("drink");
  pDrink.style.color = "red";
  pDrink.style.fontSize = "20px";
}
...
function showPrice(){
  var pOreoPrice = document.getElementById("price");
  pOreoPrice.innerHTML = "$5.55";
}
...
var buttonBox = document.getElementById("Benjamin");
buttonBox.addEventListener("click", showQuote);

function showQuote(){
  var pQuoteBox = document.getElementById("displayQuote");
  pQuoteBox.innerHTML = myQuote;
}
...
var beniButtonBox = document.getElementById("random");
beniButtonBox.addEventListener("click", randomQuote);

function randomQuote(){
  var quoteBox = document.getElementById("displayQuotes");
  var randomQuoteBox = quotes[Math.floor(Math.random()*3)];
  console.log(randomQuoteBox);
  quoteBox.innerHTML = randomQuoteBox;
}
...
var moneyButtonBox = document.getElementById("showHide");
moneyButtonBox.addEventListener("click", moneySecret);

function moneySecret(){
  var pShowMoneyBox = document.getElementById("showmoney");
